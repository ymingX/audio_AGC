...
# Memory: generic_tristate_controller
MEM_0 := generic_tristate_controller
$(MEM_0)_NAME := generic_tristate_controller
...
$(MEM_0)_SPAN := 0x00400000
$(MEM_0)_HIERARCHICAL_PATH := generic_tristate_controller
$(MEM_0)_WIDTH := 8
...
$(HDL_SIM_DIR)/$(MEM_0).dat: $(MEM_0).flash
	...
	$(FLASH2DAT) --infile=$< --outfile=$@ \
		--base=0x0 --end=0x3fffff --width=$(mem_width) \
		--create-lanes=$(mem_create_lanes) $(flash2dat_extra_args)


FLASH_DAT_FILES += $(HDL_SIM_DIR)/$(MEM_0).dat

.PHONY: generic_tristate_controller
generic_tristate_controller: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym $(MEM_0).flash
